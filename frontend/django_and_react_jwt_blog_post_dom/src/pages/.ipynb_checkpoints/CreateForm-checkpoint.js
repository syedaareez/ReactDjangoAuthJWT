...
handleSubmit(e){
    ...
    console.log('ITEM:',this.state.activeItem)
        ...
        fetch(url, {
          ...
          'X-CSRFTOKEN': `JWT ${localStorage.getItem('token')}`,
          },
            ...
            <div className="createForm">
                <div className="Form">
                    <form onSubmit={this.handleSubmit}  id="form">
                        ...
                        <input onChange={this.handleChange} className="form-code" value={this.state.activeItem.code} type="text" name="code" placeholder="Add Code for class"  />
                        <input className="form-submit-btn" type="submit" name="Add" value="create" />
                    </form>
                    </div>
